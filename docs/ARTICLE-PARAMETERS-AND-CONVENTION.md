...
## Folder convention
Published article:
- `pages/<world>/articles/<slug>/index.md`

Draft article:
- `pages/<world>/articles/draft-<slug>/index.md`
...
3. Paste the template into `index.md` (or equivalent article file used by the world pipeline).
